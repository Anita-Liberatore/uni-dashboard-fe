...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterModule, CommonModule, PageHeaderComponent, StatCardComponent, GradeBadgeComponent],
...
export class HomeComponent {
  ...
  /** Returns compact color classes for the grade square in the recent-exams list */
